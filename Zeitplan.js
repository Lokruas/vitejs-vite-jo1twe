document.addEventListener('DOMContentLoaded', function() {
    ...
    const hoverCalendarModal = document.getElementById('hover-calendar-modal');
    let calendar, hoverCalendar;
    ...
    function renderHoverCalendar() {
        const hoverCalendarEl = document.getElementById('hover-calendar');
    ...
    function updateProgressDisplay() {
        ...
        for (const planName in plans) {
            ...
            progressBar.onmouseover = function() {
                ...
                hoverCalendarModal.style.left = `${event.pageX}px`;
                hoverCalendarModal.style.top = `${event.pageY}px`;
                renderHoverCalendar();
    ...
    editSelectedPlanBtn.onclick = function() {
        ...
        if (plan) {
            ...
            document.getElementById('stack-select').value = plan.stack;
            startDate = plan.startDate;
            endDate = plan.endDate;
            milestones = plan.milestones;
            createModal.style.display = 'block';
